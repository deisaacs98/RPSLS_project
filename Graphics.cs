...
namespace RPSLS
{
    public static class Graphics
    {
        ...
        public static void TitleGraphic()
        {
            Console.WriteLine("\n\n\n\t\t                                    ______");
        ...
        public static void SelectModeGraphic()
        {
            Console.WriteLine("\n\t\t     ________________   ________________________      ___   ___ ___________   _______ ");
            Console.WriteLine("\t\t    /   __/   ___/  /  /   ___/  ____/___   ___/     /   |/   /  ___  / _ |  /   ___/");
            Console.WriteLine("\t\t   /__   /   ___/  /__/   ___/  /       /  /        / /|  // /  /  / / /| | /   ___/      ");
            Console.WriteLine("\t\t  /     /      /     /      /  /____   /  /        / / |_// /  /__/ / /_| |/      /    ");
            Console.WriteLine("\t\t /_____/______/_____/______/_______/  /__/        /_/    /_/_______/______/______/");
            Console.WriteLine("\t\t                                                               ");
        }
        public static void RockPaperScissorsGraphic()
        {
            Console.Write("\n\n\t\t\t\t\t\t   ");
        ...
        public static void LizardSpockGraphic()
        {
            Console.BackgroundColor = ConsoleColor.DarkBlue;
            Console.Write("\n\n\n\t\t\t\t\t  ");
        ...
        public static void RockTextGraphic()
        {
            Console.WriteLine("\n\n\n\n\t\t\t\t      ______");
            Console.WriteLine("\t\t\t\t     /  _   )          __    ");
            Console.WriteLine("\t\t\t\t    /     _/__________/ /_            ");
        ...
        public static void PaperTextGraphic()
        {
            Console.WriteLine("\n\n\n\n\t\t\t\t      ______");
            Console.WriteLine("\t\t\t\t     /  _   )               ");
        ...
        public static void ScissorsTextGraphic()
        {
            Console.WriteLine("\n\n\n\n\t\t\t\t      ______");
        ...
        public static void LizardTextGraphic()
        {
            Console.WriteLine("\n\n\n\n\t\t\t\t       ____                          ___  ");
        ...
        public static void BattleGraphic5()
        {
        ...
        public static void BattleGraphic6()
        {
            //Gesture gesture3 = new Gesture("Scissors", "cuts", "decapitates");
            ScissorsGraphic();
            Console.BackgroundColor = ConsoleColor.DarkBlue;
        ...
        public static void BattleGraphic10()
        {
            //Gesture gesture5 = new Gesture("Spock", "smashes", "vaporizes");
            Console.BackgroundColor = ConsoleColor.DarkBlue;
            Console.Write("\n\n\n\t\t\t\t\t   ");
